...
export default {
  ...
  'disc.privacy.p': 'SpineCalc no guarda datos. El cálculo, la anotación de la radiografía y la generación del reporte se ejecutan por completo en el navegador: las imágenes, las mediciones y los datos del caso no se transmiten a ningún servidor y se pierden al cerrar la página. No hay cuentas de usuario ni consentimientos que aceptar. Lo único que puede enviarse es la encuesta de opinión, opcional y anónima (calificación y comentario, sin identificadores).',
